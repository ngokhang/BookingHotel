...
<body>
    <header class="grid">
        <div class="header-logo">
            <svg color="#ff385c" width="102" height="32" style="display: block">
                <path
        ...
        <div class="header-search">
            <ul class="header-search-list">
                ...
                <li class="header-search-item">
                    Thành phố
                    <i class="fas fa-chevron-down" style="color: #020203"></i>
                    <div class="header-search-city">
                        <ul class="search-city-list">
                            <li class="search-city-item">Hà Nội</li>
                            <li class="search-city-item">Hồ Chí Minh</li>
                            <li class="search-city-item">Đà Nẵng</li>
                            <li class="search-city-item">Quảng Ninh</li>
                        </ul>
                    </div>
                </li>
                <li class="header-search-item">
                    Giá tiền
                    <i class="fas fa-chevron-down" style="color: #020203"></i>
                    <div class="header-search-price">
                        <ul class="search-price-list">
                            <li class="search-price-item">$0-$100</li>
                            <li class="search-price-item">$100-$200</li>
                            <li class="search-price-item">$200-$300</li>
                            <li class="search-price-item">>$300</li>
                        </ul>
                    </div>
                </li>
                <li class="header-search-item">
                    <input value="Tìm kiếm" type="submit" />
                    <i class="i-search fas fa-search" style="color: #ff385c"></i>
                </li>
            </ul>
        </div>
