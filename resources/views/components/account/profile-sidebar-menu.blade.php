  ...
  <div class="row d-flex flex-column gap-5">
    ...
    <ul class="col list-group menu-update">
      <li class="list-group-item menu-update-item">
        <a href="{{route('profile.edit')}}" class="text-decoration-none fs-5 link {{ Request::path() ==  'account' ? 'active' : '' }}">
          Your profile
        </a>
      </li>
      <li class="list-group-item menu-update-item">
        <a href="{{route('password.edit')}}" class="text-decoration-none fs-5 link {{ Request::path() ==  'account/password' ? 'active' : '' }}">
          Change password
        </a>
      </li>
      <li class="list-group-item menu-update-item">
